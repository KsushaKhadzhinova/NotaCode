...
| От Scrum | От Kanban |
|---|---|
| Спринт 1 неделя с фиксированной целью: ритм совпадает с потоком лаб | Доска с лимитами WIP: одна разработчица и агенты не должны «распыляться» |
| Planning, Review, Retro: результат спринта показывается преподавателю или себе | Непрерывный поток: срочные лабы идут через дорожку Expedite |
